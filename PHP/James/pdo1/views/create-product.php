...
<body>
    <form method="POST" action="<?= $_SERVER['PHP_SELF'] . '?action=create' ?>">
        ...
        <div>
            <label style="width: 200px;display: inline-block;">Description: </label>
            <input type="text" name="description" placeholder="Input description.." />
        </div>
        <div>
            <label style="width: 200px;display: inline-block;">Price: </label>
            <input type="text" name="price" placeholder="Input price.." />
        </div>
        <div>
            <label style="width: 200px;display: inline-block;"></label>
